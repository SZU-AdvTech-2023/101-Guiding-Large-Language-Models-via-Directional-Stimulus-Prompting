...
class Seq2SeqLMActorCriticPolicy(LMActorCriticPolicy, ActorCriticWarmStartMixin):
    ...
    def evaluate_actions(
        ...
        print("seq2seq_policy中的evaluate_actions")
...
class MaskedSeq2SeqLMActorCriticPolicy(
    ...
    def evaluate_actions(
        ...
        print("Masked seq2seq_policy中的evaluate_actions")
    ...
    def generate(
        ...
        # print(texts is None)
        # print(max_prompt_length is None)
        # exit()
        if (
            input_ids is None
