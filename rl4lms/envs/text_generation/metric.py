...
#             )
#             bleu_score = metric_results["bleu"]
#             bleu = {"lexical/bleu": (None, bleu_score)}
#             metric_m = load_metric("meteor")
#             score = metric_m.compute(
#                 predictions=generated_texts, references=reference_texts
#             )["meteor"]
#             combine = score + bleu
#             metric_dict = {"lexical/mymetric": (None, combine)}
#             return metric_dict
#         except Exception as e:
#             return {"lexical/bleu": (None, "n/a")}
#     # def compute(
...
#     #             predictions=generated_texts, references=reference_texts
#     #         )["meteor"]
#     #         combine = (score+corpus_level_score)/2
#     #         metric_dict = {"lexical/mymetric": (None,combine)}
#     #         return metric_dict
