...
from rl4lms.envs.text_generation.test_metric import (
    ...
    LLAMASummarizationWithHintMetric
)
from rl4lms.envs.text_generation.test_reward import (
    ...
    LLAMARewardSummarizationWithHint
)
...
class RewardFunctionRegistry:
    _registry = {
        ...
        "summarization_with_hint_llama": LLAMARewardSummarizationWithHint,
    }
...
class MetricRegistry:
    _registry = {
        ...
        "ter": TERMetric,
        "chrf": chrFmetric,
        "summarization_with_hint_llama": LLAMASummarizationWithHintMetric,
    }
